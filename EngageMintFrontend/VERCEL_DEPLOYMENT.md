# EngageMint Frontend Deployment on Vercel (Free)
...
- **Frontend app**: `EngageMintFrontend/` (React + Vite)
...
npm --prefix EngageMintFrontend install

npm --prefix EngageMintFrontend run build
...
3. Import repo: `JasianE/EngageMint`
...
- Fix: keep `vercel.json` in `EngageMintFrontend/`
...
- Fix: set root directory to `EngageMintFrontend`
