...
git clone <repo-url> ~/EngageMint

cd ~/EngageMint/EngageMintBackend
...
scp service-account-key.json pi@<pi-ip>:~/EngageMint/EngageMintBackend/config/



# Set environment variable (add to ~/.bashrc for persistence)

export GOOGLE_APPLICATION_CREDENTIALS="$HOME/EngageMint/EngageMintBackend/config/service-account-key.json"
...
cp model_unquant.tflite ~/EngageMint/EngageMintBackend/model/

cp labels.txt ~/EngageMint/EngageMintBackend/model/
